...
if (isDemoChatbot) {
    ...
    const storageKey = document.body.classList.contains('office-chatbot') ?
                       'office_question_count' : 'fireside_question_count';
    ...
    // --- Override Submit Handler for Question Counting ---
    // Handle both main.js system and Convai system
    ...
    if (submitBtn) {
        // Listen for the existing click event
